...
#define mi_int6store(T,A)   { uint32 def_temp= (uint32) (A),\
                              def_temp2= (uint32) ((A) >> 32);\
...
#define mi_int7store(T,A)   { uint32 def_temp= (uint32) (A),\
                              def_temp2= (uint32) ((A) >> 32);\
...
#define mi_int8store(T,A)   { uint32 def_temp3= (uint32) (A),\
